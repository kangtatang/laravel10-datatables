                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="masterDataDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Master Data
                            </a>
                            <div class="dropdown-menu" aria-labelledby="masterDataDropdown">
                                <a class="dropdown-item" href="{{ route('employees.index') }}">{{ __('Employee') }}</a>
                                <a class="dropdown-item" href="{{ route('departments.index') }}">{{ __('Department') }}</a>
                                <a class="dropdown-item" href="{{ route('job-titles.index') }}">{{ __('Job Title') }}</a>
                                <a class="dropdown-item" href="{{ route('salary-records.index') }}">{{ __('Salary Records') }}</a>
                            </div>
                        </li>
                    </ul>
